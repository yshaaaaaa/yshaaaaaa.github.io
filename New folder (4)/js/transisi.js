var PageTransitions = (function () {
  ...
  .add({
    ...
    duration: 1500,
    elasticity: 600,
    delay: 2000 // Added delay so it appears after part1
  }).add({
    targets: '.ml9',
    opacity: 1,
    duration: 60000, // 1 minute before transition
    easing: "easeOutExpo",
    delay: 1000
  }).add({
    targets: '.ml9',
  ...
  .add({
    ...
    easing: "easeOutExpo",
    duration: 1000,
    delay: (el, i) => 50 * (i+1) // Updated delay time
  }).add({
    targets: '.ml2',
    opacity: 1,
    duration: 30000, // 1 minute before transition
    easing: "easeOutExpo",
    delay: 1000
  }).add({
    targets: '.ml2',
